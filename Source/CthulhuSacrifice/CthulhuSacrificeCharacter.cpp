...
ACthulhuSacrificeCharacter::ACthulhuSacrificeCharacter()
{
...
void ACthulhuSacrificeCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ACthulhuSacrificeCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ACthulhuSacrificeCharacter::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ACthulhuSacrificeCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ACthulhuSacrificeCharacter::TouchStopped);
...
void ACthulhuSacrificeCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ACthulhuSacrificeCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}

void ACthulhuSacrificeCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void ACthulhuSacrificeCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void ACthulhuSacrificeCharacter::MoveForward(float Value)
{
...
void ACthulhuSacrificeCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
        if(GetCharacterMovement()->MovementMode == EMovementMode::MOVE_Swimming)
